  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative min-h-[900px] bg-white">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div variants={fadeSlide} className="flex justify-center lg:justify-end">
              <div className="w-full max-w-md bg-gray-200/40 backdrop-blur-sm rounded-[50px] p-8 md:p-12">
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <a href="#" className="text-red-600 text-lg md:text-xl block">Forget Password</a>
                  ...
                  <div className="text-center space-y-2">
                    <a href="#" className="text-black text-lg underline block">Google Account</a>
                    <a href="#" className="text-blue-600 text-lg block">Sign in</a>
                  </div>
                </form>
              </div>
            </motion.div>
      ...
      <div className="bg-white py-4">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-4 text-center">
            ...
            <div className="text-2xl md:text-3xl font-lato">
              Improve mental health <span className="text-blue-600 font-semibold">Together</span>
            </div>
            <div className="text-2xl md:text-3xl font-lato">
              Interaction With other <span className="text-beacon-yellow font-semibold">peoples</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-12 text-center md:text-left">
          ...
          <h2 className="text-3xl md:text-6xl font-lato font-bold">
            Your inner <span className="text-beacon-blue font-bowlby">Beacon</span> leads to peace
          </h2>
          <img
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-6xl md:text-6xl font-lato font-bold">
            <span className="text-beacon-blue">Mental stress can be eased with</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-lato text-center lg:text-left mb-6">
                Online And Offline Counselling available with <span className="text-beacon-blue font-semibold">Our Experts</span> therapists.
              </h2>
              ...
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/4db278c142672d2d40f577b394ab3fd6d19e1e19?width=560" alt="Selfie" className="mx-auto mt-8 w-56 md:w-64" />
            </div>

            <div className="bg-gray-300 rounded-[50px] border-8 border-black p-6 max-w-md mx-auto">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/fa851b56b3726627f385834b1d837446cfba4e4a?width=790" alt="Therapist" className="w-full rounded-t-[40px]" />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-6xl text-center mb-12">
            <span className="font-bowlby text-beacon-blue">Beacon</span>
            <span className="font-lato font-bold"> Helps to </span>
            <span className="font-lato font-bold text-beacon-blue">Improve</span>
            <span className="font-lato font-bold"> Your.</span>
          </h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-beacon-light-blue border-4 border-beacon-blue rounded-3xl p-8 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold">Thought Processing</h3>
            </div>
            <div className="bg-beacon-pink border-4 border-beacon-blue rounded-3xl p-8 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold">Sleep Cycle</h3>
            </div>
            <div className="bg-beacon-green border-4 border-beacon-blue rounded-3xl p-8 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold">Meditation Practice</h3>
            </div>
            <div className="bg-red-400 border-4 border-beacon-blue rounded-3xl p-8 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold">Manage Anxiety</h3>
            </div>
            <div className="bg-green-400 border-4 border-beacon-blue rounded-3xl p-8 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold">Stress Level</h3>
            </div>
            <div className="bg-yellow-300 border-4 border-beacon-blue rounded-3xl p-8 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold">Being Interactive</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl mb-12">
            <span className="font-bowlby text-beacon-blue">Beacon</span>
            <span className="font-bowlby"> — for the people, by the people who care.</span>
          </h2>

          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {["Online Therapy", "AI ChatBot", "Detox Diary", "Stress HeatMap", "Avatar"].map((feature) => (
              <button key={feature} className="bg-beacon-beige text-xl md:text-3xl font-baloo px-8 py-4 rounded-[50px] hover:bg-gray-200 transition-colors">
                {feature}
              </button>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h3 className="text-3xl md:text-4xl font-lato font-semibold mb-6">Connect and talk with experts.</h3>
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/83130707be45809816bbc1c02bc9789f130ee317?width=932" alt="Video call" className="w-full rounded-[100px]" />
            </div>
            <div className="text-white">
              <h3 className="text-4xl md:text-5xl font-lato font-bold mb-6">Here for you, always!</h3>
              <p className="text-2xl md:text-3xl font-lato font-semibold mb-8">Find the experts who can provide the answers you need.</p>
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/dda4639af4c615fed14e8c8dba859b23921926b4?width=742" alt="Reading" className="w-full max-w-md" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-beacon-beige rounded-[50px] mx-4 my-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-6xl font-lato font-bold text-center mb-6">Types and Categories of Mental Stress.</h2>
          <p className="text-2xl md:text-3xl font-lato text-center mb-12">Based on your responses to a few simple questions.</p>

          <div className="grid md:grid-cols-3 gap-6">
            <div className="border-2 border-black bg-white rounded-3xl p-6 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold text-beacon-blue">Mild Mental Stress</h3>
            </div>
            <div className="border-2 border-black bg-white rounded-3xl p-6 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold text-beacon-blue">Moderate Mental Stress</h3>
            </div>
            <div className="border-2 border-black bg-white rounded-3xl p-6 text-center">
              <h3 className="text-3xl md:text-4xl font-lato font-bold text-beacon-blue">Severe Mental Stress</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-6xl mb-8">
            ...
            <span className="font-lato font-bold text-gray-700">Designed for people, delivered with care.</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-beacon-pink rounded-3xl p-8">
              <p className="text-2xl md:text-3xl font-lato font-bold text-center mb-4">
                "Beacon is a light for the mind — guiding people from darkness to direction."
              </p>
              <p className="text-2xl md:text-3xl font-lato text-center">
                Your platform stands as a beacon (just like the name) of hope and healing, helping people navigate through emotional storms toward self-awareness and peace.
              </p>
            </div>
            ...
            <div className="bg-yellow-200 rounded-3xl p-8">
              <p className="text-2xl md:text-3xl font-lato font-bold text-beacon-blue text-center mb-4">
                "Every visit to Beacon is a step toward self-care and inner strength."
              </p>
              <p className="text-2xl md:text-3xl font-lato text-center">
                It reminds users that mental health matters every day, and even small actions — reading, reflecting, or reaching out — can bring big positive change.
              </p>
            </div>
            ...
            <div className="bg-gray-700 rounded-3xl p-8">
              <p className="text-2xl md:text-3xl font-lato font-bold text-white text-center mb-4">
                "Beacon believes that no mind should ever feel alone — because healing begins with connection."
              </p>
              <p className="text-2xl md:text-3xl font-lato text-white text-center">
                Your website creates a safe digital space where empathy, understanding, and professional guidance come together to help people rediscover balance and belonging.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex gap-4">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/170837a357b9ace5093327e7655fbd4d8815b6af?width=608" alt="Community" className="w-1/2 rounded-[50px]" />
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/73c6bf9104c0b4fdff597f9f439e0c8cbfeb88d7?width=432" alt="Community" className="w-1/3 rounded-[50px]" />
            </div>
            <div className="text-center lg:text-left">
              <h3 className="text-4xl md:text-5xl font-bowlby mb-8">People keep coming back to boost their mental wellness — together, we heal and grow.</h3>
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/3e73f7a88e3f13ed3453e77f810ecc983de3c61e?width=590" alt="Dancing" className="w-64 mx-auto lg:mx-0" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-6xl font-lato font-bold text-center mb-8">
            Explore Our <span className="font-bowlby text-beacon-blue">Beacon</span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-beacon-light-blue rounded-[30px] p-8">
                <p className="text-2xl md:text-3xl font-lato font-semibold text-center">{quote}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-lato font-bold max-w-4xl mx-auto">
            A message for those facing the same pain you endure today: You are not alone.
          </h2>
        </div>
      </section>
      ...
      <section className="py-16 bg-orange-100 rounded-[50px] mx-4 my-16">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-4xl md:text-5xl font-bookman mb-8">Join us and connect with others who share your journey.</h3>
          <h2 className="text-4xl md:text-6xl font-lato font-bold text-beacon-blue mb-8">
            Your journey to happiness begins with <span className="font-bold">The Beacon.</span>
          </h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-lato font-semibold text-center mb-12">
            Frequently Asked Question About <span className="font-bowlby text-beacon-blue">Beacon</span> ?
          </h2>
      ...
      <section className="py-0">
        <img src="./img.png" alt="Final banner" className="w-screen h-auto object-cover mx-auto block" />
      </section>
